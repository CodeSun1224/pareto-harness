...
- [ ] TASK-REQ-0034-06: 提交 exact design candidate，确认仅含设计与工作记录。Validation: `git diff --name-status e7a939cad71a85ada97c3b60d61ba5c024d85ab9...HEAD`.
- [ ] TASK-REQ-0034-07: fresh independent Reviewer 使用 architecture-review 和 code-review 写 REVIEW-0018。Validation: Reviewer-owned formal Review only.
