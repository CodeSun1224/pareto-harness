...
use crate::{
    ...
    HookRequestViewV1, HookStreamInitializedPayloadV1, KernelMeterEvidenceV1,
    LateResultObservedPayloadV1, LifecycleAdmissionV1, ObserverResultV1,
    OperationReservedPayloadV1, OperationSettledPayloadV1, ProjectionHistorySeedV1,
    ProjectionHistoryStepV1, ProjectionReducerDescriptorV1, ProjectionReducerRef,
    ProtectedOperationDeniedPayloadV1, ProtectedProposalHashViewV1, ProtocolLimitsProfileV1,
...
pub fn generate_schema_set() -> Result<Vec<SchemaDocument>, ValidationError> {
    let mut schemas = vec![
        ...
        generate::<HookRequestViewV1>("hook-request-view", 1, 0)?,
